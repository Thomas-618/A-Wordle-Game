...
public partial class Game : Node
{
	...
	public string SelectWord() 
	{
		...
		string filePath = 
			$"res://src/main/resources/words/selectable/{WordLength}.txt";
		using (FileAccess selectableWords = 
	...
	public Guess.Result MakeGuess(string word)
	{
